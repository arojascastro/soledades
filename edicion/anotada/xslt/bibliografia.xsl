...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" version="2.0">
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="edicion/soledad_segunda.html">Soledad segunda</a>
                    </li>
                  </ul>
                </li>
                <li class="dropdown">
        ...
        <div class="container-fluid text-center">
          ...
          <div class="row content">
            ...
            <div class="col-sm-8 text-left">
              ...
              <h1>
                <xsl:value-of select="//tei:back//tei:head"/>
              </h1>

              <ul>
                <xsl:for-each select="//tei:back//tei:bibl">
                  <xsl:variable name="id-ref" select="//tei:p//tei:ref[@target = concat('#', current()/@xml:id)]/@target[1]"/>
                  <li>
                    <xsl:apply-templates/>
                    <!-- this is wrong because it should link to the ref @xml:id but first you need to give a @xml:id to each ref -->
                    <a href="{$id-ref[1]}"> &#8617;</a>
                  </li>
                </xsl:for-each>
              </ul>
  ...
  <xsl:template match="tei:back//tei:author">
    <span xmlns="http://www.w3.org/1999/xhtml" class="author">
      <xsl:apply-templates/>
    </span>
  </xsl:template>

  <xsl:template match="tei:back//tei:title">
    <span xmlns="http://www.w3.org/1999/xhtml" class="title">
      <xsl:apply-templates/>
    </span>
  </xsl:template>
