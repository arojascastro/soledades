              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="#">Situación enunciativa</a>
                    </li>
                    <li>
                      <a href="#">Género literario</a>
                    </li>
                  </ul>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="#">Soledad primera</a>
                    </li>
                    <li>
                      <a href="#">Soledad segunda</a>
                    </li>
                  </ul>
                </li>
                <li class="dropdown">
        ...
        <div class="container-fluid text-center">
          ...
          <p><a href="#">Soledad segunda</a></p>-->
            ...
            <div class="col-sm-8 text-left">
              ...
              <xsl:apply-templates select="//tei:front/tei:div/tei:div[@xml:id = 'titulo']"/>
