...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" version="2.0">
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="estudio/plan.html">Asunto</a>
                    </li>
                    <li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="edicion/dedicatoria.html">Dedicatoria</a>
                    </li>
                    <li>
                      <a href="edicion/soledad_primera.html">Soledad primera</a>
                    </li>
                    <li>
                      <a href="edicion/solead_segunda.html">Soledad segunda</a>
                    </li>
                  </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="indice/onomastico.html">Onomástico</a>
                    </li>
                    <li>
                      <a href="indice/toponimos.html">Topónimos</a>
                    </li>
                  </ul>
                </li>
                <li>
        ...
        <div class="container-fluid text-center">
          ...
          <div class="row content">
            ...
            <div class="col-sm-8 text-left">
              <xsl:apply-templates select="//tei:front/tei:div[@xml:id = 'inicio']"/>
            </div>
  ...
  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:head[@type = 'main']">
  ...
  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:p/tei:hi[@rend = 'italic']">
    <em xmlns="http://www.w3.org/1999/xhtml">
     <xsl:apply-templates/>
    </em>
  </xsl:template>

  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:p">
    <p xmlns="http://www.w3.org/1999/xhtml">
      <xsl:apply-templates/>
    </p>
  </xsl:template>

  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:list">
    <div class="list-group" xmlns="http://www.w3.org/1999/xhtml">
      <xsl:apply-templates/>
    </div>
  </xsl:template>

  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:list/tei:item">
    <a href="{./tei:ref/@target}" class="list-group-item" xmlns="http://www.w3.org/1999/xhtml">
     <xsl:apply-templates/>
    </a>
  </xsl:template>

  <xsl:template match="//tei:front/tei:div[@xml:id = 'inicio']/tei:p/tei:ref">
